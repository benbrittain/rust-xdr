...
impl<'a> CodeWriter<'a> {
    ...
    pub fn write_codec_header(&mut self) {
        ...
        self.write_line("use xdrgen::service::*;");
        self.write_line("");
    }
    ...
    pub fn pub_struct_no_body<S : AsRef<str>>(&mut self, name: S) {
        self.write_line("");
        self.write_line(&format!("pub struct {};", name.as_ref()));
    }
