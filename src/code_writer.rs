...
impl<'a> CodeWriter<'a> {
    ...
    pub fn write_codec_header(&mut self) {
        self.comment("autogenerated by xdrust");
        self.comment("boilerplate for tokio services");
        self.write_line("use std::{io, result};");
        self.write_line("use tokio_core::io::{Codec, EasyBuf};");
        self.write_line("use xdrgen::experiment_prot;");
    ...
    pub fn write_service_header(&mut self) {
        self.comment("Autogenerated by xdrust");
        self.write_line("#[allow(dead_code)]");
        self.write_line("use std::io;");
        self.write_line("use std::ops::DerefMut;");
		self.write_line("use tokio_service::Service;");
		...
		self.write_line("use xdrgen::experiment_prot::*;");
		self.write_line("use xdrgen::experiment_prot::rpc::*;");
		self.write_line("use xdrgen::xdr_rpc;");
		self.write_line("use std::default::Default;");
		//use service::ExperimentdbdProgService;
        self.write_line("use serde_xdr;");
        self.write_line("");
    }
    ...
    pub fn alias_impl<S : AsRef<str>, F>(&mut self, prefix: &str,  name: S, mut cb: F)
	...
	pub fn impl_<S: AsRef<str>, F>(&mut self, traits: S, trait_name: S, struct_name: S, cb: F)
						 where F : FnMut(&mut CodeWriter) {
        self.expr_block(&format!("impl{} {} for {}",
								 traits.as_ref(),
								 trait_name.as_ref(),
								 struct_name.as_ref()), "", cb);
	}
